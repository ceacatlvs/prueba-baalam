...
@Entity
@Table( name = "ago_anticonceptivos_actuales",
		uniqueConstraints = @UniqueConstraint(columnNames = "idAgoAnticonceptivosActual"))
public class AGOAnticonceptivosActual implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name = "idAgoAnticonceptivosActual")
	private Long idAgoAnticonceptivosActual;
	...
	public Long getIdAgoAnticonceptivosActual() {
		return idAgoAnticonceptivosActual;
	}

	public void setIdAgoAnticonceptivosActual(Long idAgoAnticonceptivosActual) {
		this.idAgoAnticonceptivosActual = idAgoAnticonceptivosActual;
	}
